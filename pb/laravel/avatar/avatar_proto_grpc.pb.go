...
func (c *avatarServiceClient) GetAvatar(ctx context.Context, in *AvatarRequest, opts ...grpc.CallOption) (*AvatarResponse, error) {
	out := new(AvatarResponse)
	err := c.cc.Invoke(ctx, "/whatw_golang_laravel.AvatarService/GetAvatar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAvatarServiceServer) GetAvatar(context.Context, *AvatarRequest) (*AvatarResponse, error) {
...
func _AvatarService_GetAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/whatw_golang_laravel.AvatarService/GetAvatar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvatarServiceServer).GetAvatar(ctx, req.(*AvatarRequest))
	}
...
var AvatarService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "whatw_golang_laravel.AvatarService",
	...
	Metadata: "proto/avatar_proto.proto",
}
