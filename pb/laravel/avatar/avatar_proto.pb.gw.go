...
/*
Package avatar is a reverse proxy.
...
func request_AvatarService_GetAvatar_0(ctx context.Context, marshaler runtime.Marshaler, client AvatarServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AvatarRequest
...
func RegisterAvatarServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AvatarServiceClient) error {
	...
	mux.Handle("GET", pattern_AvatarService_GetAvatar_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AvatarService_GetAvatar_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_AvatarService_GetAvatar_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_AvatarService_GetAvatar_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "avatars"}, ""))
)

var (
	forward_AvatarService_GetAvatar_0 = runtime.ForwardResponseMessage
)
